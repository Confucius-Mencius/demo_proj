#ifndef DEMO_SERVER_TCP_LOGICS_DEMO1002_NFY_HANDLER_H_
#define DEMO_SERVER_TCP_LOGICS_DEMO1002_NFY_HANDLER_H_
...
#endif // DEMO_SERVER_TCP_LOGICS_DEMO1002_NFY_HANDLER_H_
