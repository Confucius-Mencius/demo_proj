#ifndef DEMO_SERVER_WEB_LOGICS_CROSSDOMAIN_REQ_HANDLER_H_
#define DEMO_SERVER_WEB_LOGICS_CROSSDOMAIN_REQ_HANDLER_H_
...
#endif // DEMO_SERVER_WEB_LOGICS_CROSSDOMAIN_REQ_HANDLER_H_
