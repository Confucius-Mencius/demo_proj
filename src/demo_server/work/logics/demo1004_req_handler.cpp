                               ...
                               const void* msg_body, size_t msg_body_len)
{
    ...
    if (SendToTCPThread(logic_ctx_->scheduler, conn_guid, demo1008_req_msg_head, &demo1008_req, conn_guid->io_thread_idx) != 0)
    {
        LOG_ERROR("failed to send to tcp thread, " << *conn_guid << ", msg id: " << demo1008_req_msg_head.msg_id);
        return;
    }
