#ifndef DEMO_SERVER_WORK_LOGICS_DEMO_6_REQ_HANDLER_H_
#define DEMO_SERVER_WORK_LOGICS_DEMO_6_REQ_HANDLER_H_
...
#endif // DEMO_SERVER_WORK_LOGICS_DEMO_6_REQ_HANDLER_H_
