...
{
    msg_handler_vec_.push_back(&demo1002_nfy_handler_);
    msg_handler_vec_.push_back(&demo1003_req_handler_);
    msg_handler_vec_.push_back(&demo1008_req_handler_);
    msg_handler_vec_.push_back(&demo1020_req_handler_);
