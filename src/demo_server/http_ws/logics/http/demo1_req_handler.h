#ifndef DEMO_SERVER_HTTP_WS_LOGICS_DEMO1_REQ_HANDLER_H_
#define DEMO_SERVER_HTTP_WS_LOGICS_DEMO1_REQ_HANDLER_H_
...
#endif // DEMO_SERVER_HTTP_WS_LOGICS_DEMO1_REQ_HANDLER_H_
