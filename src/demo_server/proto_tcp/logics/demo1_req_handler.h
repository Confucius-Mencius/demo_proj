#ifndef DEMO_SERVER_PROTO_TCP_LOGICS_DEMO1_REQ_HANDLER_H_
#define DEMO_SERVER_PROTO_TCP_LOGICS_DEMO1_REQ_HANDLER_H_
...
#endif // DEMO_SERVER_PROTO_TCP_LOGICS_DEMO1_REQ_HANDLER_H_
