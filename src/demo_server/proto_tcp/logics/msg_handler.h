#ifndef DEMO_SERVER_PROTO_TCP_LOGICS_MSG_HANDLER_H_
#define DEMO_SERVER_PROTO_TCP_LOGICS_MSG_HANDLER_H_

// 一般做一个MsgHandler的基类，放消息处理器公用的一些函数

#include "proto_tcp_common_logic_interface.h"
#include "proto_tcp_msg_handler_interface.h"
...
#endif // DEMO_SERVER_PROTO_TCP_LOGICS_MSG_HANDLER_H_
