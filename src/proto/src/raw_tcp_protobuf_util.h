#ifndef PROTO_SRC_RAW_TCP_PROTOBUF_UTIL_H_
#define PROTO_SRC_RAW_TCP_PROTOBUF_UTIL_H_
...
inline int SendToGlobalThread(tcp::raw::SchedulerInterface* scheduler, const ConnGUID* conn_guid,
...
inline int SendToTCPThread(tcp::raw::SchedulerInterface* scheduler, const ConnGUID* conn_guid,
                           const ::proto::MsgHead& msg_head, const google::protobuf::Message* protobuf_msg,
                           int tcp_thread_idx)
{
    char* msg_body = nullptr;
...
inline int SendToWorkThread(tcp::raw::SchedulerInterface* scheduler, const ConnGUID* conn_guid,
                            const ::proto::MsgHead& msg_head, const google::protobuf::Message* protobuf_msg,
                            int work_thread_idx)
{
    char* msg_body = nullptr;
...
#endif // PROTO_SRC_RAW_TCP_PROTOBUF_UTIL_H_
