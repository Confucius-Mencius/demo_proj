...
class ErrCtxDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<ErrCtx> _instance;
} _ErrCtx_default_instance_;
}  // namespace demo
}  // namespace moon
}  // namespace com
static void InitDefaultsErrCtx_common_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_ErrCtx_common_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsErrCtx_common_2eproto}, {}};

void InitDefaults_common_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_ErrCtx_common_2eproto.base);
}
...
const ::google::protobuf::uint32 TableStruct_common_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::com::moon::demo::ErrCtx, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::com::moon::demo::ErrCtx, err_code_),
  PROTOBUF_FIELD_OFFSET(::com::moon::demo::ErrCtx, err_msg_),
};
...
::google::protobuf::internal::DescriptorTable descriptor_table_common_2eproto = {
  ...
  "common.proto", &assign_descriptors_table_common_2eproto, 82,
};
...
const char* ErrCtx::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<ErrCtx*>(object);
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 2: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("com.moon.demo.ErrCtx.err_msg");
...
// @@protoc_insertion_point(generalized_merge_from_start:com.moon.demo.ErrCtx)
  ...
  const ErrCtx* source =
      ::google::protobuf::DynamicCastToGenerated<ErrCtx>(
          &from);
  if (source == nullptr) {
...
namespace google {
namespace protobuf {
template<> PROTOBUF_NOINLINE ::com::moon::demo::ErrCtx* Arena::CreateMaybeMessage< ::com::moon::demo::ErrCtx >(Arena* arena) {
